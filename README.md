...
- **ČD rail** — assorted DMU and EMU classes (809/810 Šukafon + 010 trailer · 811 RegioMouse · 842/843/844 ·
...
- **Stations** (`VZ-Stations-rail.pak`) — narrow low platforms with level track
  crossings, as at Světlá nad Sázavou or Nezamyslice: concrete slabs, paving
  blocks with a tactile strip, or gravel with Sudop edges, each also with a
  crossing through the middle and an end-of-crossing tile for the last track,
  plus crossing-only tiles (concrete, rubber and wooden panels). Sprites are generated by `tools/gen_platforms.py`.
